...
let arr = []
let big = document.querySelectorAll('.second-and-third-list');
var small;
...
for (var ele of dataitems) {//遍历出所有的
    var obj = {};
    // var img = ele.querySelectorAll('.list-flex-wrap img');  //找到所有的图片
    var list = ele.querySelectorAll('.flex-item');
    list.forEach((items, index2) => {
